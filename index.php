        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content">
              ...
              <hr>
              <h3>Toko kelontong terlengkap di Karanganyar</h3><br>
              <p>Awal bulan bingung mau belanja kemana? Belanja di toko kami saja. Banyak sekali barang yg tersedia di toko kami.</p>
              <p>“Dapatkan jaminan 100% uang kembali jika produk yang Anda terima tidak sesuai foto dan deskripsi kami.”</p>
              <ul>
                <li><i class="ion-android-checkmark-circle"></i> Aman
                </li>
                <li><i class="ion-android-checkmark-circle"></i> Murah
                </li>
                <li><i class="ion-android-checkmark-circle"></i> Terpercaya</li>
              </ul>
            </div>
          </div>
        </div>
